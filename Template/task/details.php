<section id="task-summary">
    ...
    <?= $this->url->button('bars', t('Back to the board'), 'DueDateController', 'show', array('project_id' => $project['id'], 'plugin' => 'Duedate'), false, 'view-duedate', t('Keyboard shortcut: "%s"', 'v d')) ?>
