...
class DueDateController extends BaseController
{
    ...
    public function readonly()
    {
        ...
        $this->response->html($this->helper->layout->app('board/view_public', array(
            'project' => $project,
            'swimlanes' => $this->dueDateFormatter
                ->withProjectId($project['id'])
                ->withQuery($query)
                ->format()
            ,
            'title' => "tit". $project['name'],
    ...
    public function show()
    {
        ...
        $this->response->html($this->helper->layout->app('Duedate:board/view_private', array(
            'project' => $project,
            'title' => $project['name'],
            ...
            'swimlanes' => $this->taskLexer
                ->build($search)
                ->format($this->dueDateFormatter->withProjectId($project['id']))
        )));
    }
}